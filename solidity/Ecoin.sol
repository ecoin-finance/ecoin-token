...
contract EcoinToken is GasHelper, ERC20 {
  ...
  function totalSupply() public view override returns (uint256) { return super.totalSupply() - totalBurned; }
  ...
  function killDeadTokens() external isAuthorized(0) { _balances[DEAD] = 0; }
